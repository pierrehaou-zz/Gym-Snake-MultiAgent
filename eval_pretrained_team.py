...
def main():
    ...
    with tf.compat.v1.Session() as sess:
        sess.run(init)
        saver_new_model_1.restore(sess, './pretrained_models/pretrained_models_team\model-agent_b_1_26082.ckpt')
        saver_new_model_3.restore(sess, './pretrained_models/pretrained_models_team\model-agent_b_3_26082.ckpt')
