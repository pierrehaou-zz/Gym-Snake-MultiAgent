...
saving_path = "pretrained_models/pretrained_models_selfplay_3"
load_model_path = "pretrained_models/pretrained_models_selfplay_3"
    ...
    with tf.compat.v1.Session() as sess:
        ...
        for i in range(num_episodes):
            ...
            if len(reward_list_agent_2) % 10 == 0:
                print(i, "agent_3", np.mean(reward_list_agent_3[-10:]), e)
                print(i, "agent_2", np.mean(reward_list_agent_2[-10:]), e)
                print(i, "agent_1", np.mean(reward_list_agent_1[-10:]), e)
                print("")
